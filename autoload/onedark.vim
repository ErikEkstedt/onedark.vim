...
let s:colors = {
      ...
      \ "green_bright": get(s:overrides, "green", { "gui": "#56f482", "cterm": "114", "cterm16": "2" }),
      ...
      \ "purple_bright": get(s:overrides, "purple", { "gui": "#a000ff", "cterm": "170", "cterm16": "5" }),
      \ "pink_bright": get(s:overrides, "vertsplit", { "gui": "#e400ff", "cterm": "59", "cterm16": "15" }),
      \ "pink_dim": get(s:overrides, "vertsplit", { "gui": "#f043b5", "cterm": "59", "cterm16": "15" }),
      \ "cyan_bright": get(s:overrides, "vertsplit", { "gui": "#00ceff", "cterm": "59", "cterm16": "15" }),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#56B6C2", "cterm": "38", "cterm16": "6" }),
      \ "white": get(s:overrides, "white", { "gui": "#ABB2BF", "cterm": "145", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#141619", "cterm": "235", "cterm16": "0" }),
